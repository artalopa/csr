...
@section('sub_title-2')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('gallery-committee-web.index') }}">
            Kegiatan Komite
        </a>
    </li>
@endsection
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-9 col-xl-8 col-lg-7 ratio_50">
                    <div class="blog-detail-image rounded-3 mb-4 bg-size blur-up lazyloaded"
                        style="background-image: url(&quot;{{ asset('uploads/gallery/' . $gallery->image) }}&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                        <img src="{{ asset('uploads/gallery/' . $gallery->image) }}" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="blog-image-contain">
                            <ul class="contain-list">
                                <li>{{ $gallery->GalleryCommitteeCategory->name ?? 'Uncategorized' }}</li>
                            </ul>
                            <h2>{{ $gallery->title }}</h2>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-5 d-lg-block d-none">
                    <div class="left-sidebar-box">
                        ...
                        {{-- Recent post --}}
                        @include('galleries_csr.components.recent-post')
                        {{-- Recent post end --}}
                    </div>
                </div>
            </div>
