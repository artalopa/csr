...
@section('sub_title-2')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/information/csr-news') }}">
            Berita CSR
        </a>
    </li>
@endsection
@section('sub_title-3', 'Agriculture Conference Harvest 2022 In Paris')
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-9 col-xl-8 col-lg-7 ratio_50">
                    <div class="blog-detail-image rounded-3 mb-4 bg-size blur-up lazyloaded"
                        ...
                        <img src="../../user/images/slider (1).jpg" class="bg-img blur-up lazyload" alt="">
