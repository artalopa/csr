                ...
                <div class="col-xl-5">
                    <div class="faq-contain">
                        ...
                        <p>We are answering most frequent questions. No worries if you not find exact one. You can find
                            out more by searching or continuing clicking button below or directly <a href="contact-us.html"
                        ...
                        <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <p>Fastkart is leading the charge in transforming India’s vast, unorganised
                                            ...
                                            news, directly via your mobile or web browser.</p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Discover, Explore & Understanding The News Description Maecenas
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        How do I find my Windows News key? <i class="fa-solid fa-angle-down"></i>
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingEight">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        How Can I Get More Attention From Customers? <i class="fa-solid fa-angle-down"></i>
                                    </button>
                                </h2>
