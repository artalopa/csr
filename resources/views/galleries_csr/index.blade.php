...
@endsection
@section('sub_title-3', 'Kegiatan CSR')
            ...
            <div class="row g-4">
                <div class="col-xxl-12 col-xl-12 col-lg-7 order-lg-1">
                    <div class="row g-4 ratio_65">
                        ...
                        {{-- preview: 12 Kegiatan CSR --}}
                        @foreach ($galleries as $result => $key)
                            <div class="col-xxl-4 col-sm-6">
                                <div class="blog-box wow fadeInUp">
                                    <div class="blog-image">
                                        <a href="{{ route('gallery-csr-web.show', ['slug' => $key->slug]) }}"
                                    ...
                                    <div class="blog-contain">
                                        ...
                                        <button
                                            onclick="location.href = '{{ route('gallery-csr-web.show', ['slug' => $key->slug]) }}';"
