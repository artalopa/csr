                ...
                <div class="recent-post-box">
                    ...
                    @foreach ($recent as $recent)
                        <div class="recent-box">
                            <a href="{{ route('csr-about-web.show', ['slug' => $recent->slug]) }}" class="recent-image">
                                <img src="{{ asset('uploads/csr_about/' . $recent->image) }}"
                                    class="img-fluid blur-up lazyload" alt="">
                            </a>

                            <div class="recent-detail">
                                <a href="{{ route('csr-about-web.show', ['slug' => $recent->slug]) }}">
