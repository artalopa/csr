...
@section('sub_title-2')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('csr-about-web.index') }}">
            Tentang CSR
        </a>
    </li>
@endsection
@section('sub_title-3')
    {{ Str::limit($csr_about->title, 30) }}
@endsection
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-9 col-xl-8 col-lg-7 ratio_50">
                    <div class="blog-detail-image rounded-3 mb-4 bg-size blur-up lazyloaded"
                        style="background-image: url(&quot;{{ asset('uploads/csr_about/' . $csr_about->image) }}&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                        <img src="{{ asset('uploads/csr_about/' . $csr_about->image) }}" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="blog-image-contain">
                            <ul class="contain-list">
                                <li>
                                    {{ $csr_about->CsrAboutCategory->name ?? 'Uncategorized' }}
                                </li>
                                {{-- <li>life style</li> --}}
                                {{-- <li>organic</li> --}}
                            </ul>
                            <h2>{{ $csr_about->title }}</h2>
                            <ul class="contain-comment-list">
                                ...
                                <li>
                                    <div class="user-list">
                                        ...
                                        <span>{{ Str::limit($csr_about->created_at, 10, '') }}</span>
                                    </div>
                                </li>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-5 d-lg-block d-none">
                    <div class="left-sidebar-box">
                        ...
                        {{-- Recent post --}}
                        @include('information_csr_about.components.recent-post')
                        {{-- Recent post end --}}
                    </div>
                </div>
            </div>
