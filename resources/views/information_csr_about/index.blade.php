...
@endsection
@section('sub_title-3', 'Tentang CSR')
                            ...
                            <div class="carousel-inner h-25 ">
                                @foreach ($slider as $slider)
                                    <div class="carousel-item">
                                        <img src="{{ asset('uploads/csr_about/' . $slider->image) }}"
                            ...
                            <div class="col-xxl-4 col-sm-6">
                                <div class="blog-box wow fadeInUp">
                                    <div class="blog-image">
                                        <a href="{{ route('csr-about-web.show', ['slug' => $key->slug]) }}"
                                            class="bg-size blur-up lazyload"
                                            style="background-image: url(&quot;{{ asset('uploads/csr_about/' . $key->image) }}&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                                            <img src="{{ asset('uploads/csr_about/' . $key->image) }}"
                                    ...
                                    <div class="blog-contain">
                                        ...
                                        <button
                                            onclick="location.href = '{{ route('csr-about-web.show', ['slug' => $key->slug]) }}';"
