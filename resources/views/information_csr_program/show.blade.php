...
@section('sub_title-2')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('csr-program-web.index') }}">
            Program CSR
        </a>
    </li>
@endsection
@section('sub_title-3')
    {{ Str::limit($csr_program->title, 30) }}
@endsection
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-9 col-xl-8 col-lg-7 ratio_50">
                    <div class="blog-detail-image rounded-3 mb-4 bg-size blur-up lazyloaded"
                        style="background-image: url(&quot;{{ asset('uploads/csr_program/' . $csr_program->image) }}&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                        <img src="{{ asset('uploads/csr_program/' . $csr_program->image) }}" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="blog-image-contain">
                            <ul class="contain-list">
                                <li>
                                    {{ $csr_program->CsrProgramCategory->name ?? 'Uncategorized' }}
                                </li>
                                {{-- <li>life style</li> --}}
                                {{-- <li>organic</li> --}}
                            </ul>
                            <h2>{{ $csr_program->title }}</h2>
                            <ul class="contain-comment-list">
                                ...
                                <li>
                                    <div class="user-list">
                                        ...
                                        <span>{{ Str::limit($csr_program->created_at, 10, '') }}</span>
                                    </div>
                                </li>
                                    ...
                                    <div class="user-box border-color">
                                        ...
                                        <div class="user-contain">
                                            <p>"Yeah, I think maybe you do. Right, gimme a Pepsi free. Of course, the
                                                ...
                                                where they kiss for the first time. You'll find out. Are you sure program
                                                this storm?"</p>
                                        </div>
                                    </div>
                                </li>
