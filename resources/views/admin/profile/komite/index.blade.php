...
@section('title-content', 'PROFILE KOMITE TSP')
...
@section('content')
    <form
        action="@if (!empty($profileKomite)) {{ route('profile-komite.update', $profileKomite->id) }} @else {{ route('profile-komite.store') }} @endif"
...
@section('js')
    ...
    <script>
        var quill = new Quill("#editor", {
            theme: "snow",
            placeholder: "Tulis Profile Komite TSP"
        });
