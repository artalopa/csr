...
@section('title-content', 'KATEGORI KEGIATAN CSR')
...
@section('link-address')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">
            <a href="{{ route('gallery-csr.index') }}">Galeri Kegiatan CSR</a>
        </li>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('gallery-csr-category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form action="{{ route('gallery-csr-category.destroy', $key->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                    ...
                                    <div class="modal fade" id="{{ $key->slug }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('gallery-csr-category.update', $key->slug) }}"
