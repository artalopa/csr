...
@section('title-content', 'KATEGORI KEGIATAN KOMITE')
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('gallery-committee-category.store') }}" method="POST"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form action="{{ route('gallery-committee-category.destroy', $key->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                    ...
                                    <div class="modal fade" id="{{ $key->slug }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('gallery-committee-category.update', $key->slug) }}"
