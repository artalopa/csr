...
class GalleryCsrCategoryController extends Controller
{
    protected $category;

    public function __construct(GalleryCsrCategory $category)
    {
    ...
    public function index()
    {
        ...
        return view('admin.gallery_csr.category.index', compact('categories'));
    }

    public function store(Request $request)
    {
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:gallery_csr_categories,name,',
    ...
    public function update(Request $request, $slug)
    {
        ...
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:gallery_csr_categories,name,' . $category->id,
            'image' => 'nullable|mimes:png,jpg,jpeg|max:2048',
            'description' => 'nullable'
        ]);
