...
class CsrProgramCategoryController extends Controller
{
    protected $category;

    public function __construct(CsrProgramCategory $category)
    {
    ...
    public function index()
    {
        ...
        return view('admin.information_csr_program.category.index', compact('categories'));
    }

    public function store(Request $request)
    {
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:csr_program_categories,name,',
    ...
    public function update(Request $request, $slug)
    {
        ...
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:csr_program_categories,name,' . $category->id,
