...
class SimoncerCategoryController extends Controller
{
    protected $category;

    public function __construct(SimoncerCategory $category)
    {
    ...
    public function index()
    {
        ...
        return view('admin.information_simoncer.category.index', compact('categories'));
    }

    public function store(Request $request)
    {
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:simoncer_categories,name,',
    ...
    public function update(Request $request, $slug)
    {
        ...
        $this->validate($request, [
            'name' => 'required|string|max:255|unique:simoncer_categories,name,' . $category->id,
