(function ($) {
    ...
    $(".grid-option .grid-btn").on("click", function () {
        $(".news-list-section").removeClass("list-style");
    });
    $(".grid-option .list-btn").on("click", function () {
        $(".news-list-section").addClass("list-style");
    });
    ...
    $.notify(
        {
            icon: "fa fa-check",
            title: "Alert!",
            message: "Terimaksih atas kunjungan Anda",
        },
        {
            element: "body",
            position: null,
...
/*=====================
   17. active class Js
   ==========================*/
$(".news-packege .select-packege li a").click(function () {
    $("li a").removeClass("active");
    $(this).addClass("active");
});
...
$(".close_button").click(function () {
    $(this)
        .closest(".news-box-contain")
        .fadeOut("slow", function () {
            $(this).closest(".news-box-contain").remove();
        });
});
